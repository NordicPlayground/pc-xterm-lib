...
var _terminal, _prompt, _config, _historyAddon, _lineSpan, _lineCount, _userInput_1, _cursorInputIndex_1, _registeredCommands, _userInputChangeListeners, _runCommandListeners;
...
_terminal = new WeakMap(), _prompt = new WeakMap(), _config = new WeakMap(), _historyAddon = new WeakMap(), _lineSpan = new WeakMap(), _lineCount = new WeakMap(), _userInput_1 = new WeakMap(), _cursorInputIndex_1 = new WeakMap(), _registeredCommands = new WeakMap(), _userInputChangeListeners = new WeakMap(), _runCommandListeners = new WeakMap();
