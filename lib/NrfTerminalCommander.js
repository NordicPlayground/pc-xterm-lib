...
var _terminal, _prompt, _config, _historyAddon, _lineSpan, _lineCount, _userInput_1, _cursorInputIndex_1, _registeredCommands, _userInputChangeListeners, _runCommandListeners, _keyListener, _dataListener;
...
class NrfTerminalCommander {
    ...
    set terminalMode(terminalMode) {
        ...
        if (terminalMode.type == 'character') {
            __classPrivateFieldSet(this, _keyListener, __classPrivateFieldGet(this, _terminal).onKey(terminalMode.onKey));
